...
python3 main.py --global-settings $CO_SIM_USE_CASE_ROOT_PATH/EBRAINS_WorkflowConfigurations/global_settings/global_settings.xml --action-plan $CO_SIM_USE_CASE_ROOT_PATH/EBRAINS_WorkflowConfigurations/plans/cosim_zerlaut_on_local.xml
