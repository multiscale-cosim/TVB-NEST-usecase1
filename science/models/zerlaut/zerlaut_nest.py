...
###################################
    ...
    def __network_initialisation_neurons(self, results_path, param_topology, return_gids=False, cosimulation=None):
        """
    ...
    def __init_connection(self, dic_layer, param_topology, param_connection):
        """
    ...
    def __create_homogenous_connection(self, dic_layer, param_topology, param_connection, save=False, init=None):
        """
    ...
    def __create_heterogeneous_connection(self, dic_layer, param_topology, param_connection, save=False, init=None,
                                        cosimulation=None):
        """
    ...
    def __network_device(self, results_path, dic_layer, min_time, time_simulation, param_background, param_connection, mpi=False,
                   cosimulation=None):
        """
