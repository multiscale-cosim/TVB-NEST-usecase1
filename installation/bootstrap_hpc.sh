...
CO_SIM_ROOT_PATH=${PROJECT_cslns}/${LOGNAME}/multiscale-cosim
...
cd ${CO_SIM_REPOS}
git clone --recurse-submodules https://github.com/multiscale-cosim/TVB-NEST-usecase1.git
